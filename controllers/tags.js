...
exports.index = async (req, res) => {
	...
	const [tags, places, count] = await Promise.all([tagsPromise, placesPromise, countPromise]);
	...
	if ( !tag ) {
		res.render('tags/index', { pageTitle, tags, tag, places, page, pages, count, paginationLinkUrl: `/tags/page/`, queryString: '' } );
	} else {
		res.render('tags/index', { pageTitle, tags, tag, places, page, pages, count, paginationLinkUrl: `/tags/${tag}/page/`, queryString: '' } );
	}
