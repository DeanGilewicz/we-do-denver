...
exports.category = async (req, res) => {
	...
	let placesPromise;
  	...
  	if( sortBy === 'visits') {
  		placesPromise = Place.aggregate([
	  		{ "$match" : { owner: {$eq: req.user._id}, 'category.slug': {$eq: categorySlug} } },
	...
	res.render('category/index', { pageTitle, categorySlug, places, page, pages, count, paginationLinkUrl: `/categories/${categorySlug}/page/`, queryString } );
};
